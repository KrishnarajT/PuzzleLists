...
class Player( GenShip ):
    ...
    def PlayerHealthBar_( self, Window ):
        pygame.draw.rect( Window, (255, 0, 0),
                          (round( self.x ), round( self.y + self.Ship_Image.get_height() + 10 ),
                           round( self.Ship_Image.get_width() ), 10) )
        pygame.draw.rect( Window, (0, 255, 0), (round( self.x ), round( self.y + self.Ship_Image.get_height() + 10 ),
...
def drawText( level, life, player_Obj, won_Level = False ):
    # FONTS
    main_Font = pygame.font.Font( os.path.join('Fonts', 'F-Roboto-Thin.ttf'), 50 )
    level_Won_Font = pygame.font.Font( os.path.join('Fonts', 'CloisterBlack.ttf'), 250 )
