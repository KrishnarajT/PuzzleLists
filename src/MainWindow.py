...
class Ui_Puzzlelists(QMainWindow):
	...
	def setupUi(self):
		...
		self.login_welcome_lbl.setFont(
			QFont(self.games_Font, pointSize=60, weight=50)
		)
		...
		self.signup_enterPass_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.signup_enterName_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.signup_enterEmail_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.signup_enterOtp_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.signup_remark_lbl.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.fpass_enterEmail_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.fpass_enterPass_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.fpass_enterOtp_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.fpass_enterName_lineedit.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		self.fpass_sendOtp_btn.setFont(QFont(self.games_played_Font, pointSize=20, weight=50))
		...
		self.fpass_verifyOtp_btn.setFont(QFont(self.games_played_Font, pointSize=20, weight=50))
		...
		self.fpass_remark_lbl.setFont(QFont(self.games_played_Font, pointSize=22, weight=50))
		...
		font = QtGui.QFont()
		self.chgame_game1_btn.setFont(QFont(self.squid_game_Font, pointSize=30, weight=50))
		...
		font = QtGui.QFont()
		self.chgame_game2_btn.setFont(QFont(self.squid_game_Font, pointSize=30, weight=50))
		...
		font = QtGui.QFont()
		self.chgame_game3_btn.setFont(QFont(self.squid_game_Font, pointSize=30, weight=50))
		...
		font = QtGui.QFont()
		self.chgame_game4_btn.setFont(QFont(self.squid_game_Font, pointSize=30, weight=50))
		...
		font = QtGui.QFont()
		self.chgame_game5_btn.setFont(QFont(self.squid_game_Font, pointSize=30, weight=50))
		...
		self.chgame_viewScore_btn.setFont(QFont(self.games_played_Font, pointSize=20, weight=50))
		...
		self.hgscore_welcome_lbl.setFont(QFont(self.games_Font, pointSize=75, weight=50))
		...
		self.hgscore_backToGame_btn.setFont(QFont(self.games_played_Font, pointSize=20, weight=50))
