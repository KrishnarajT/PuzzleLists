...
class Ui_Puzzlelists(object):
    def setupUi(self, Puzzlelists):
        ...
        icon.addPixmap(
            QtGui.QPixmap(
                "/run/media/krishnaraj/Programs/Python/PuzzleLists/design/../resources/logo/icon.svg"
            ),
            QtGui.QIcon.Mode.Normal,
            QtGui.QIcon.State.Off,
        )
        Puzzlelists.setWindowIcon(icon)
        Puzzlelists.setStyleSheet(
            "background: url('/run/media/krishnaraj/Programs/Python/PuzzleLists/resources/images/login_bg_blur.jpg');\n"
            'color:"#be3114"\n'
            ""
        )
        ...
        self.login_newUser_btn.setStyleSheet(
        ...
        self.login_forgotPass_btn.setStyleSheet(
            "background:transparent;\n" 'color: "#fea7ec"'
        )
        ...
        self.login_enterPass_lineedit.setStyleSheet(
            "background: transparent;\n" 'color: "#fea7ec"'
        )
        ...
        self.login_Begin_btn.setStyleSheet(
